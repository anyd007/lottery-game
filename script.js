...
// });
first.textContent = "gracz nr1".toUpperCase();
sec.textContent = "gracz nr2".toUpperCase();
...
const addNameByPlayer = () => {
  ...
  if (player1Input.value !== "") {
    let firstName = (first.textContent = player1Input.value.toUpperCase());
    player1Input.value = "";
...
const addNameByPlayer2 = () => {
  if (player2Input.value !== "") {
    let secendName = (sec.textContent = player2Input.value.toUpperCase());
    player2Input.value = "";
